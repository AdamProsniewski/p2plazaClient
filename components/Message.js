export default function Message(props){
    return (
        ...
        <div class="pb-2">
        <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-2xl shadow-xl shadow-slate-300/60" key={props.createdAt}>
              ...
              <div>
                ...
                <div class="p-1">
                  <p class="text-gray-900 border-l-2 px-1 border-blue-500 bg-gray-100 rounded">{props.message}</p>
                </div>
                <p className="text-sm tracking-tight font-light text-slate-400 leading-6">{props.createdAt}</p>
              </div>
            </div>
